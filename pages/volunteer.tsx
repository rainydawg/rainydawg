    ...
    <Layout title="Volunteer">
      <div>
        ...
        <p>
          ...
          <a href="https://forms.gle/f9P9kfv3hEsKstgD9">DJ application.</a>
        </p>
        ...
        <p>
          ...
          and want to find other like minded individuals. Volunteer DJ
        </p>
        ...
        <p>
          ...
          more. We mostly hire the majority of DJs in the fall, however our
          operations are being reformatted for safety and security during the
          times, and volunteer DJs will be temporarily on hold.
        </p>
        ...
        <h2>Music Specialist</h2>

        <p>
          As a music specialist you’ll aid our director of music by being
